    ...
    <>
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogTrigger className="">
          <span className="block text-white text-[20px] md:text-[24px] xl:text-[20px] font-bold">
            {t("sign")}
          </span>
          <MoveRight
            size={35}
            className={`text-white flex justify-center items-center ${
              i18n.language == "uz"
                ? "hidden md:ml-24 xl:ml-20 md:block"
                : "ml-10 md:ml-14 xl:ml-10"
            }`}
          />
        </DialogTrigger>
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              <form onSubmit={hnadleOrder}>
                ...
                <button
                  type="submit"
                  className="bg-[#3679A4] w-full text-[14px] md:text-[16px] xl:text-[18px] mt-3 text-white py-2 rounded-lg font-bold"
                >
                  {t("leaveRequest")}
                </button>
                 ...
                 <div className="flex flex-col gap-[20px]  lg:flex-row mt-5    items-center lg:justify-between">
                  ...
                  >
                    ...
                    <p className="w-[50%] mx-auto flex flex-row items-center gap-2"><IoCall />{t("call")}</p>
                  </a>
