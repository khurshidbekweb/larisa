...
import mobile_uz from '@/assets/image/desktop_e_uz.png'
        ...
        <section className=" relative mt-10 md:mt-14 xl:mt-20">
            <div className="recommunded-inner">
                ...
                <div className=" bg-[#89BFDB1A] ">
                    <div className="max-w-7xl mx-auto mt-36 xl:mt-24 xl:flex xl:items-center xl:justify-between">
                        {i18n.language=='uz'?
                        <>
                        <img className="block md:hidden absolute top-[200px]" src={mobile_uz} alt="mobile" />
                        <img className="hidden md:block absolute left-1/4 md:top-36 xl:relative xl:left-0 xl:top-0" src={desktop_uz} alt="mobile" />
                        </>
                        :<>
                            <img className="block md:hidden absolute top-[150px]" src={mobile} alt="mobile" />
                            <img className="hidden md:block absolute left-1/4 md:top-36 xl:relative xl:left-0 xl:top-0" src={desktop} alt="mobile" />
                        </>}
                        <ul className="flex flex-col md:flex-row md:flex-wrap md:justify-between space-y-3 md:space-y-0 md:gap-5 pt-36 py-4 px-4 xl:w-[60%] xl:mt-[0px] xl:py-0 xl:px-4">
