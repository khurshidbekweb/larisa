...
export const SliderData = [
  ...
  { id: 4, image: user4, title: { ru: "Сухость кожи", uz: "Teri quruqligi" } },
  { id: 5, image: user1, title: { ru: "Чувство жажды", uz: "Chanqoqlik" } },
  { id: 6, image: user5, title: { ru: "Раздражительность", uz: "Jahldorlik" } },
];